...
class WrongNumberOfTypeLevelArgumentsError(val expected: Int, val actual: Int, source: Source)
    : TypeCheckError("Expected $expected type-level arguments, but got $actual", source)
...
class CouldNotFindDiscriminator(val sourceType: Type, val targetType: TypeLevelValue, source: Source)
